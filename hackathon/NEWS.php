            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">CATEGORY</a>
                    ...
                    <!-- <li class="nav-item">
                        <a href="signup.php" class="nav-link page-scroll">SIGN U<span class="pf pf-amazon-pay"></span></a>
                    </li> -->
                </ul>
...
if (!$conn){
  die("Sorry we failed to connect: ". mysqli_connect_error());
        ...
        $sql = "SELECT * FROM blogdata WHERE  category='news';";
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <img class="img-fluid mt-5 mb-3" src="sport/353631.jpg" alt="alternative">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of ex-basic-1 -->
    ...
    <div class="ex-basic-1 pt-4 bg-dark-blue">
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    <p>Shubman Gill will head into the Border Gavaskar Trophy with plenty of confidence after an exceptional performance in the limited-overs series against New Zealand. </p>
                    <p class="mb-5">While he struggled in the first two T20Is after a sublime showing in the ODI series, his 63-ball 126 helped India win the series 2-1 and potentially launch his T20I career.Amid criticism over his intent and strike rate, Gill shattered records with his superbly paced knock that's also the highest T20I score for an Indian batter. </p>
