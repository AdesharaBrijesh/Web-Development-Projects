...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- <div id="loading">
        <img id="loading-image" src="Rhombus.gif" alt="Loading..." />
      </div> -->
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-xl-7">
                                            <div class="image-container">
                                                <img class="img-fluid" src="sport/football(1).jpg" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6 col-xl-5">
                                            <div class="text-container">
                                                <h1 class="h1-large">Latest Information About Sports</h1>
                                                <p class="p-large">Know About Most career matches in T20I history</p>
                                                <a class="btn-solid-lg page-scroll" href="Sport.php">MORE</a>
                                ...
                                <div class="swiper-slide">
                                    <div class="row">
                                        <div class="col-lg-6 col-xl-7">
                                            <div class="image-container">
                                                <img class="img-fluid" src="movies/movie.jpg" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6 col-xl-5">
                                            <div class="text-container">
                                                <h1 class="h1-large">Up coming Movies & Series</h1>
                                                <p class="p-large">All detail about Up coming all Bollywood Hollywood movie & series this year</p>
                                                <a class="btn-solid-lg page-scroll" href="movies.php">MORE</a>
                                ...
                                <div class="swiper-slide">
                                    <div class="row">
                                        <div class="col-lg-6 col-xl-7">
                                            <div class="image-container">
                                                <img class="img-fluid" src="news/news(1).jpg" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6 col-xl-5">
                                            <div class="text-container">
                                                <h1 class="h1-large">National $ International NEWS</h1>
                                                <p class="p-large">Know about national & international situations</p>
                                                <a class="btn-solid-lg page-scroll" href="NEWS.php">MORE</a>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>Register with email for regular update on your favorite topick </p>
                ...
                <div class="col-lg-6">
                    ...
                    <form id="registrationForm">
                        ...
                        <div class="form-group checkbox">
                            <input type="checkbox" id="rterms" value="Agreed-to-Terms" required>I agree with the website's <a href="privacy.php">Privacy Policy</a> and <a href="terms.php">Terms & Conditions</a>
                        </div>
                        <div class="form-group">
    ...
    <div id="details" class="basic-1 bg-dark-blue">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="news/rbi 1.jpg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        <h2>Move fast, regulators: Adani group crisis calls for incisive response from Sebi, RBI. Financial panic has a habit of spreading</h2>
                        <p>The day after Adani Enterprises decided not to go ahead with its fully subscribed follow-on public offer (FPO), its shares closed lower by 27% at Rs 1,565.30. It’s now around half the floor price of the FPO. In all, seven listed companies of the Adani group have lost more than $100 billion in market value since January 24.</p>
	...
	<div id="details-lightbox" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
			<div class="col-lg-8">
                <div class="image-container">
                    <img class="img-fluid" src="news/hollywood.jpeg" alt="alternative">
                </div> <!-- end of image-container -->
			</div> <!-- end of col -->
			<div class="col-lg-4">
                <h3>Goals Setting</h3>
                ...
                <a class="btn-solid-reg mfp-close page-scroll" href="#registration">MORE</a> <button class="btn-outline-reg mfp-close as-button" type="button">BACK</button>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="tabs-container">
                        ...
                        <ul class="nav nav-tabs" id="revoTabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true">Marval</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="nav-tab-2" data-toggle="tab" href="#tab-2" role="tab" aria-controls="tab-2" aria-selected="false">DC</a>
                            </li>
                        </ul>
                        <!-- end of tabs links -->
                        ...
                        <div class="tab-content" id="revoTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                                <h4>Marvel Up Coming movie</h4>
                                <p>Also marvel relase features section shows how we are able to achieve all this.</p>
                                <ul class="list-unstyled li-space-lg">
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body"><strong>"Ant-Man and The Wasp: Quantumania"</strong> Date (February 17, 2023)</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body"><strong>"Guardians of the Galaxy Vol. 3"</strong>Date (May 5, 2023)</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body"><strong>"Ironheart"</strong>Date (Late 2023)</div>
                                    </li>
                                </ul>
                            </div> <!-- end of tab-pane --> 
                            <!-- end of tab -->
                            ...
                            <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                                <ul class="list-unstyled li-space-lg">
                                    <li class="media">
                                        ...
                                        <div class="media-body"><strong>"The Batman"</strong>(March 24, 2023)</div>
                                    </li>
                                    <li class="media">
                                        <div class="media-bullet">2.</div>
                                        <div class="media-body"><strong>"Shazam! Fury of the Gods"</strong>(June 2, 2023)</div>
                                    </li>
                                    <li class="media">
                                        <div class="media-bullet">3.</div>
                                        <div class="media-body"><strong>"Aquaman 2"</strong>(December 15, 2023)</div>
                                    </li>
                                    <li class="media">
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © <a href="#your-link">SHADOW</a></p>
                </div> <!-- end of col -->
                <!-- <div class="col-lg-12">
